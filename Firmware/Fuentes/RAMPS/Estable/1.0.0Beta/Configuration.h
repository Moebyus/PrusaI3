...
#define STRING_CONFIG_H_AUTHOR "(MoebyusMachine - javier@moebyus.com)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "Prusai3-MM"
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER -54.0
...
#define HOMING_FEEDRATE {60*60, 60*60, 2*60, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.20,80.20,4020,750}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 2, 30}    // (mm/sec)
...
//#define LCD_FEEDBACK_FREQUENCY_HZ 500	// this is the tone frequency the buzzer plays when on UI feedback. ie Screen Click
