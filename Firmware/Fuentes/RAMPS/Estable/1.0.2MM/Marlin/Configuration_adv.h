...
#define EXTRUDER_0_AUTO_FAN_PIN   0
#define EXTRUDER_1_AUTO_FAN_PIN   -1
#define EXTRUDER_2_AUTO_FAN_PIN   -1
#define EXTRUDER_AUTO_FAN_TEMPERATURE 60
#define EXTRUDER_AUTO_FAN_SPEED    140  // == full speed
...
#ifdef ULTIPANEL
#define MANUAL_FEEDRATE {75*60, 75*60, 3*60, 300}  // set the speeds for manual moves (mm/min)
#endif
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_Z_MULTIPLICATOR 4 //faster z movements
...
#define FWRETRACT  //ONLY PARTIALLY TESTED
  ...
  #define RETRACT_RECOVER_LENGTH 1       //default additional recover length (mm, added to retract length when recovering)
  #define RETRACT_RECOVER_LENGTH_SWAP 20  //default additional swap recover length (mm, added to retract length when recovering from extruder change)
