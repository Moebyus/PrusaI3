...
#define STRING_CONFIG_H_AUTHOR "(Moebyus Machines, www.moebyus.com)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "PrusaMM"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,95}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 3, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1500,800,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
