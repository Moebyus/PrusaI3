...
#define CUSTOM_MENDEL_NAME "I3MM-Autol"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.16,80.16,4020,760}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {150, 150, 20, 35}    // (mm/sec)
